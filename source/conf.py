...
project = u'Kolab Groupware'
import datetime
copyright = u'2011-%s, Kolab Systems AG' % (datetime.datetime.strftime(datetime.datetime.utcnow(), '%Y'))
...
exclude_patterns = [ 'webmail-user-guide/roundcubemail-plugins-kolab/*' ]
