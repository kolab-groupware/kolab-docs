.. _installation-winterfell-debian-8:

============================================
Installation of Kolab Winterfell on Debian 8
============================================
...
1.  Add the following two lines to ``/etc/apt/sources.list.d/kolab.list``:
    ...
    .. parsed-literal::
        ...
        deb http://obs.kolabsys.com/repositories/Kolab:/Winterfell/Debian_8.0/ ./
        deb-src http://obs.kolabsys.com/repositories/Kolab:/Winterfell/Debian_8.0/ ./
