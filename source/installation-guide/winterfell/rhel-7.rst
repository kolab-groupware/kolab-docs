.. _installation-guide-winterfell-rhel-7:

==============================================================
Installation of Kolab Winterfell on Red Hat Enterprise Linux 7
==============================================================
...
2.  Install the Kolab Groupware repository configuration:
    ...
    .. parsed-literal::
        ...
        # :command:`wget http://obs.kolabsys.com/repositories/Kolab:/Winterfell/RHEL_7/Kolab:Winterfell.repo`
