...
CentOS is a community-driven (re-)distribution of Red Hat Enterprise
Linux. This documentation therefore concerns the installation of the
**community edition of Kolab Groupware** on the **community edition of
Enterprise Linux**.

For the installation of the supported Kolab Enterprise edition, please
see :ref:`installation-rhel`, even when you actually run CentOS.
